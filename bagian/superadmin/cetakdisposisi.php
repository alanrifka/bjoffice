            ...
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span >Telp (0274)375127 Fax (0274) 374870</span>';
                        echo '<span id="alamat">Jl. Patangpuluhan No.1, Patangpuluhan, Wirobrajan, Kota Yogyakarta, Daerah Istimewa Yogyakarta 55251</span>';
                        echo '<span ></span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td id="right" width="18%"><strong>Derajat</strong></td>
